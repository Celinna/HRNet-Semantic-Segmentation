...
CONFIG="seg_hrnet_w32_train_768x1024_sgd_lr1e-2_wd5e-4_bs_12_epoch100_fold1"
...
CONFIG="seg_hrnet_w32_train_768x1024_sgd_lr1e-2_wd5e-4_bs_12_epoch100_fold2"
$PY_CMD tools/train.py --cfg experiments/swiss_okutama/$CONFIG.yaml
python tools/test.py --cfg experiments/swiss_okutama/$CONFIG.yaml \
...
CONFIG="seg_hrnet_w32_train_768x1024_sgd_lr1e-2_wd5e-4_bs_12_epoch100_fold3"
$PY_CMD tools/train.py --cfg experiments/swiss_okutama/$CONFIG.yaml
python tools/test.py --cfg experiments/swiss_okutama/$CONFIG.yaml \
