...
class SwissOkutama(BaseDataset):
    def __init__(self, 
        ...
        elif '_2' in self.list_path:
            self.class_weights = torch.FloatTensor([6.699001879139657, 0.6816159924402315, 
                                                    0.5112979374995403, 0.633428278056009,
                                                    12.77304199819539, 0.39885832055087045, 
                                                    5.010507620844638, 15.605886025712465]).cuda()
            
        elif '_3' in self.list_path:
            self.class_weights = torch.FloatTensor([6.479937984725079, 0.6880501659271935, 
                                                    0.6206182314982152, 0.46329955925193317, 
                                                    27.180200294411286, 0.42598766414193906,
                                                    6.3468554146749865, 12.386623620525322]).cuda()
