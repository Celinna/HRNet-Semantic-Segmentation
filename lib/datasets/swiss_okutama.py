...
class SwissOkutama(BaseDataset):
    def __init__(self, 
        ...
        self.class_weights = torch.FloatTensor([5.711834870255004, 0.7145547291856146, 0.6094225911041463, 0.3866978575477097, 10.748178474536623, 0.4305995615726381, 10.675418358834811, 7: 12.346768995845355, 1.6433640405630534]).cuda()
