...
# Written by Celinna Ju (yi.ju@epfl.ch)
# ------------------------------------------------------------------------------
...
class BasicBlock_Attention(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.att_bn1 = nn.BatchNorm2d(int(planes/8), momentum=BN_MOMENTUM)
        self.att3 = nn.Conv2d(int(planes/8), planes, 1, 1, bias=False)
        self.att_bn2 = nn.BatchNorm2d(planes, momentum=BN_MOMENTUM)
